...
<script type="text/javascript" src="<?php echo URL_BASE?>js/js.js"></script>
<!--menu mobile-->  
<script>
	$(function(){
...
<?php include "cabecalho.php"?>
		...
		<?php
					...
					$paginas = array('home','carrinho','categoria','subcategoria','produto',
									 'compra-finalizada','nao-logado','carrinho-vazio','cadastro',
									 'pagamento','transferencia','login','lojacompleta','lista-cursos');
