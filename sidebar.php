...
<a href="#"><img src="<?php echo URL_BASE ?>imagens/img-publicidade.png"></a>
	<div class="ultimo-lanc">
		...
		<div class="caixa">
			<img src="http://localhost/sistema_formacao_php/lojavirtual_pronta/produtos/motog3g.jpg">
			<div class="del">
				<h4><a href="#">Smartphone Motorola Moto G 3ª Geração...</a></h4>
				<div class="prc-ant">De <small> R$ 10460.94</small><font> Por</font></div>
				<span>R$ 9000.00</span>
				<form id="form1" name="frmcarrinho" method="post" action="http://localhost/sistema_formacao_php/lojavirtual_pronta/carrinho">
					...
					<input type="submit" name="imageField" class="comprar" value="Ver detalhes">
				</form>
